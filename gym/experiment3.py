...
if __name__ == '__main__':
    ...
    dataset_path = f'data/{variant["env"]}-{variant["dataset"]}-v2.pkl'
    ...
    for i in range(10):
        ...
        experiment('gym-experiment', variant, trajectories, state_mean, state_std, run_id)
